...
export default function ProfileButton() {
  ...
  return (
    <div className="relative" ref={ref}>
      {/* Trigger button — always shows person icon */}
      <button
        onClick={() => setOpen((v) => !v)}
      ...
      {open && (
        <div
          role="menu"
          className="dropdown-animate absolute top-[calc(100%+10px)] right-0 min-w-[220px] bg-card border border-border rounded-[18px] shadow-[0_16px_40px_rgba(24,20,18,0.14)] p-2 z-50"
        >
          {/* User header */}
